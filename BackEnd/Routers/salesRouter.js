...
const { SalesCompStore, SalesCompBrand, SalesCompClass, SalesRankStock, DailySalesSum } = require('../Controllers/Sales/salesReport');
...
router.get('/SalesCompBrand', SalesCompBrand)
router.get('/SalesCompClass', SalesCompClass)
